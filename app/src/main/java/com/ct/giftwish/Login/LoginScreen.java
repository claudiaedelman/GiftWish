...
public class LoginScreen extends AppCompatActivity {
    ...
    private void getData(JSONObject object) {
        try {
            URL profile_picture = new URL("https://graph.facebook.com/"+object.getString("id")+"/picture?width=250&heught=250");
    ...
    private void printKeyHash() {
        try{
            PackageInfo info = getPackageManager().getPackageInfo("com.ct.giftwish",PackageManager.GET_SIGNATURES);
